...
def login():
	...
	if usernameVar.get()=="1" and passwordVar.get()=="1":
		...
		if counterlogin==1:
			...
			#############################################RECEIPT###############################################################################
			txtReceipt=Text(Receipt_F,width=46,height=10,bg='white',bd=4,font=('arial',12,'bold'))
...
label=Label(userright,image=image1,width=170,height=200,bg="pink")
